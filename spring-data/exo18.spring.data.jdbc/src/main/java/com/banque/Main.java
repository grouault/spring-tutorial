...
public final class Main {
	...
	public static void main(String[] args) {
		...
		try (ClassPathXmlApplicationContext appContext = new ClassPathXmlApplicationContext("spring/*-context.xml");) {
			...
			ICompteService serviceCpt = appContext.getBean(ICompteService.class);
			...
			// operations
			IOperationService serviceOp = appContext.getBean(IOperationService.class);
