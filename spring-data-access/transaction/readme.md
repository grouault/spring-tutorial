...
### 2.2 Défaut de recouvrabilité
  ...
  Principe: généralement, on cherche les écritures dans l'exécution. Ensuite, pour une écriture donnée, on vérifie s'il existe après d'autres lectures/écritures sur la même variable, réalisées par d'autres transactions. Une lecture peut indiquer un problème de recouvrablité / annulation en cascade, une écriture un problème d'exécution stricte.
