...
import com.banque.config.SpringDaoConfig;
import com.banque.config.SpringServiceConfig2;
...
public final class Main {
	...
	public static void main(String[] args) throws Exception {
		Main.LOG.info("-- Debut -- ");
			...
			AnnotationConfigApplicationContext context = new AnnotationConfigApplicationContext(SpringServiceConfig2.class, SpringDaoConfig.class);
