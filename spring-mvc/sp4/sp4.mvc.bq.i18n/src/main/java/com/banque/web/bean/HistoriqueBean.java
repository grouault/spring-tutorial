...
public class HistoriqueBean implements Serializable {
	...
	public HistoriqueBean(HttpServletRequest request) {
		super();
		String sid = request.getParameter("cptId");
		String sdd = request.getParameter("dateDebut");
		String sdf = request.getParameter("dateFin");
		String sc = request.getParameter("credit");
		String sd = request.getParameter("debit");
