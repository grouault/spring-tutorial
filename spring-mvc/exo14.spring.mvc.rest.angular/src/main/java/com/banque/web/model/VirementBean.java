...
public class VirementBean implements Serializable {
	...
	public Integer getCptSrcIdAsInt() {
		try {
			...
			VirementBean.LOG.trace("Erreur sur cpt src", e);
		}
		return null;
	}
	 ...
	 */
	public Integer getCptDstIdAsInt() {
		try {
			return Integer.valueOf(this.cptDstId);
		} catch (Exception e) {
			VirementBean.LOG.trace("Erreur sur cpt dst", e);
		}
		return null;
	}
	...
	/**
	 * Recupere la propriete <i>montant</i> sous forme de double.
	 *
	 * @return the montant la valeur de la propriete.
	 */
	public Double getMontantAsDouble() {
		try {
			...
			VirementBean.LOG.trace("Erreur sur le montant", e);
		}
		return null;
	}
	...
	public String toString() {
		...
		builder.append(" [cptSrcId=");
		builder.append(this.cptSrcId);
		builder.append(", cptDstId=");
		builder.append(this.cptDstId);
